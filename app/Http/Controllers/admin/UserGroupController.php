...
class UserGroupController extends Controller
{
    ...
    public function save(Request $request)
    {
        ...
        //Write log
        createLog(static::$module, __FUNCTION__, 0, ['data' => $data, 'user_group_permission' => $content]);
    ...
    public function update(Request $request)
    {
        ...
        //Write log
        createLog(static::$module, __FUNCTION__, $id, ['data' => $data, 'user_group_permission' => $content]);
